...
// CRUD - you can tighten RBAC as needed; defaulting to ADMIN-only for write ops.
courseRouter.post("/", authJwt, requireRoles("ADMIN"), validate({ body: CourseCreateDto }), controller.create);
courseRouter.patch(
  "/:id",
  authJwt,
  requireRoles("ADMIN"),
